...
| :--- | :--- | :--- |
| `G` | graph | the graph. |
| `is_left` | vertexProp<bool> | boolean vertex property stating the side of the vertices in the [bipartite](https://docs.oracle.com/en/database/oracle/property-graph/24.3/spgdg/graph-mutation-and-subgraphs.html) graph (left for hubs, right for auths). |
